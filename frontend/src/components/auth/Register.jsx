...
const Register = () => {
  ...
  const validateEmail = (email) => {
    return email.toLowerCase().endsWith('@mallareddyuniversity.ac.in');
  };
    ...
    <div className="min-h-screen pt-24 pb-12 flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow-md">
        <div>
          ...
          <h2 className="text-3xl font-bold text-center text-gray-900">Create Student Account</h2>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="2211CS030169@mallareddyuniversity.ac.in"
                />
