...
const FacultyRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validate form
    if (!formData.name || !formData.email || !formData.password || !formData.department || !formData.officeRoom) {
    ...
    if (!validateEmail(formData.email)) {
      setError('Please use your university email address (@mallareddyuniversity.ac.in)');
      setIsLoading(false);
      return;
    }
    ...
    <div className="min-h-screen pt-24 pb-12 flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow-md">
        <div>
          ...
          <h2 className="text-3xl font-bold text-center text-gray-900">Faculty Registration</h2>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="officeRoom" className="block text-sm font-medium text-gray-700">
                Office Room Number *
              </label>
              <input
                id="officeRoom"
